...
<body style="font-family: Arial, sans-serif; margin: 0; padding: 0; background-color: #f4f4f4;">
  <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 20px;">
    ...
    <div class="mobile-content" style="font-size: 16px; color: #666666; line-height: 1.5;">
      ...
      <a href=${`"https://syrs-debug.akamir.com/${test.lang}/result/${result.id}"`} class="mobile-button" style="display: block; margin: 20px auto; padding: 10px 20px; background-color: #d1b89d; color: #ffffff; text-align: center; text-decoration: none; border-radius: 5px; font-size: 16px;">${locale[test.lang].buttonText}</a>
    </div>
