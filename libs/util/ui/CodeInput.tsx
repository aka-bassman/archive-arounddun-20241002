...
export const CodeInput = ({
  ...
  const defaultUnitClassName =
    unitStyle === "box" ? "border border-gray-300 rounded items-center" : "border-b border-gray-300 items-end pb-2";
  ...
  return (
    <div className={clsx("relative   flex items-center  justify-center gap-2", className)}>
      ...
      <input
        ...
        className={`absolute size-full border-none text-transparent caret-transparent  outline-none focus:outline-none`}
      />
    </div>
  );
};
