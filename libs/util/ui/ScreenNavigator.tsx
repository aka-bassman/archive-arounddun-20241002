...
import { SpringValue, a, useSpringValue } from "react-spring";
...
export const ScreenNavigator = ({
  ...
  useEffect(() => {
    ...
    currentMenu === menus[1] ? xValue.set(-deviceWidth) : xValue.set(0);
  }, []);
  ...
  return (
    <ScreenNavigatorContext.Provider value={{ bind, xValue, onClickMenu, menus, currentMenu, setMenu }}>
      <a.div {...bind()} className="flex h-full w-[200vw] overflow-x-scroll" style={{ x: xValue }} ref={ref}>
        {children}
      </a.div>
