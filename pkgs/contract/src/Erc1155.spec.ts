// import { AkaMarket, ERC1155, Multicall as MulticallContract, erc1155, multicall as mc, market as mk } from "@contract";
...
//       ? new ethers.providers.JsonRpcProvider(env.ethereum.signal)
